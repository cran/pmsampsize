...
test_that("Test 3.1", {
  ss <- c(4286, 760, 4286, 4286)
  SPP <- c(23.07, 4.09, 23.07, 23.07)
...
test_that("Test 3.2", {
  ss <- c(3335, 757, 3335, 3335)
  SPP <- c(17.95, 4.07, 17.95, 17.95)
...
test_that("Test 3.4", {
  ss <- c(4286, 636, 4286, 4286)
  SPP <- c(35.49, 5.27, 35.49, 35.49)
...
test_that("Test 3.6", {
  ss <- c(4286, 555, 4286, 4286)
  SPP <- c(44.57, 5.77, 44.57, 44.57)
...
test_that("Test 3.7", {
  ss <- c(5798, 806, 5798, 5798)
  SPP <- c(57.98, 8.06, 57.98, 57.98)
...
test_that("Test 3.8", {
  ss <- c(2950, 230, 2950, 2950)
  SPP <- c(79.65, 6.21, 79.65, 79.65)
...
test_that("Test 3.9", {
  ss <- c(1974, 1770, 1974, 1974)
  SPP <- c(3.7, 3.32, 3.7, 3.7)
